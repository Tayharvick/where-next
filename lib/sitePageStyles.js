...
export const SITE_PAGE_STYLES = `
  ...
  .site-nav-bar{display:flex;align-items:flex-start;justify-content:space-between;gap:24px;padding:32px 0 28px;border-bottom:1px solid ${C.rule}}
  ...
  .content-subpage{padding:56px 0 120px}
  .content-subpage .scout-masthead{padding:0 0 48px}
  ...
  @media(max-width:760px){
    ...
    .content-subpage{padding:32px 0 80px}
    .content-subpage .scout-masthead{padding:0 0 32px}
  }
`;
